...
export default {
  ...
  cityShort: '新',
  authorizedSign: '深圳市前海亿车科技有限公司提供技术支持',
  appLocation: { 'longitude': 87.623272, 'latitude': 43.831565 }, //新疆经、纬度
  //appLocation: { 'longitude': 113.87400574113, 'latitude': 22.573178069501 }, //深圳经、纬度
  //appActivityType: 2,  //活动类型，0是无活动，1是优惠券，2是折扣，3是二者同时有。
  carnumTopTwoDefault: ['新', 'H'], //扫码输入车牌号查找停车订单去缴费时，车牌号前两位默认值。
  //telOfScanCarnumPay: '0717-6232550', //扫码输入车牌号查找停车订单去缴费功能：订单详情页底部的客服电话。
  telOfCustomer: '0991-4180037', //关于我们客服电话
  platformFlag: 'xinjiangflag',//平台标识 用于cookie分别
  website: 'http://www.czjcz.net', //暂无
}; 
